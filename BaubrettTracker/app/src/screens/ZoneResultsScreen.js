 ...
 *
 * Simplified view shows only: Baubrett # + Delete button
 * Full details are available by tapping the card (navigates to ConsultResult).
 *
 ...
 * 5. Simplified display: Baubrett # + delete button only (tap card for full details)
 *
